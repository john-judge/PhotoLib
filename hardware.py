...
class Hardware:
    ...
    def get_camera_program(self, **kwargs):
    ...
    def set_duration(self, **kwargs):
        self.lib.setDuration(self.controller, kwargs.duration)
    ...
    def get_acqui_onset(self, **kwargs):
        return self.lib.getAcquiOnset(self.controller)

    def ni_error_dump(self, **kwargs):
        self.lib.NiErrorDump(self.controller)

    def get_acqui_duration(self, **kwargs):
    ...
    def get_num_dark_rli(self, **kwargs):
    ...
    def get_num_light_rli(self, **kwargs):
